...
export default function Payments() {
  ...
  const recoveredArrears = useMemo(() => {
    ...
    return (payments || [])
      ...
      // UNIQUEMENT les VRAIS arriérés : loyers explicitement marqués « arriéré »
      // (onglet Arriérés → isArrear) OU générés impayés par une clôture de mois
      // (autoGenerated) puis réglés. On N'inclut PAS le simple repère post-clôture,
      // car tout paiement saisi après une clôture le porte (paiement normal ≠ arriéré).
      ...
      .map(p => {
        ...
        // Le mois couvert doit être PASSÉ, ou un mois déjà CLÔTURÉ (le mois en cours
        // devient arriéré une fois clôturé).
        ...
        // Un loyer flaggé arriéré (isArrear/autoGenerated) EST un arriéré recouvré
        // dès qu'il est payé, quel que soit le délai (même recouvré le mois même
        // d'une clôture). Pas de condition de « retard ≥ 1 mois » ici.
